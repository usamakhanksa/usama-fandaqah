...
return new class extends Migration {
  public function up(): void {
    ...
    Schema::create('reservations',function(Blueprint $t){$t->id();$t->string('code');$t->foreignId('guest_id')->constrained();$t->foreignId('room_id')->constrained();$t->foreignId('unit_id')->nullable()->constrained();$t->foreignId('reservation_status_id')->constrained();$t->date('check_in');$t->date('check_out');$t->string('stay_type')->default('checkin');$t->timestamps();});
