...
class GrantAddCustomersPermissionToOtherRoles extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'grant:edit-reservation-after-checking';
        ...
        foreach ($teams as $team) {
            foreach ($team->roles as $role) {
                if ($role->slug != 'housekeeping') {
                    $role->grant('edit reservations after checkin');
                }
            }
        }
    }
