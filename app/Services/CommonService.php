...
class CommonService
{
     ...
     * @return Transaction
     */
    public function forceWithdraw(Wallet $wallet, int $amount, ?array $meta, bool $confirmed = true, bool $public = true): Transaction
    {
     ...
     * @return Transaction
     */
    public function deposit(Wallet $wallet, int $amount, ?array $meta, bool $confirmed = true, bool $public = false): Transaction
    {
        $walletService = app(WalletService::class);
        $walletService->checkAmount($amount);
