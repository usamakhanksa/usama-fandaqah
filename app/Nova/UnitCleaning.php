...
use Surelab\ImagesCustomField\ImagesCustomField;
use Laravel\Nova\Http\Requests\NovaRequest;
use Illuminate\Support\Collection;

class UnitCleaning extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = 'App\UnitCleaning';
    ...
    {
        return __('Housekeeping service') ;
    }
...
//            })->asHtml()->onlyOnDetail(),
            ...
            ImagesCustomField::make(__('Attachements') , 'images_urls')->onlyOnDetail()
