...
trait HasWalletFloat
{
     ...
     * @return Transaction
     */
    public function forceWithdrawFloat(float $amount, ?array $meta = null, bool $confirmed = true , bool $public = true): Transaction
    {
        $decimalPlaces = app(WalletService::class)->decimalPlaces($this);
        return $this->forceWithdraw($amount * $decimalPlaces, $meta, $confirmed, $public);
    }
     ...
     * @return Transaction
     */
    public function depositFloat(float $amount, ?array $meta = null, bool $confirmed = true,bool $public = true): Transaction
    {
        $decimalPlaces = app(WalletService::class)->decimalPlaces($this);
        return $this->deposit($amount * $decimalPlaces, $meta, $confirmed,$public);
    }
