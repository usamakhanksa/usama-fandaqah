...
trait HasWallet
{
     ...
     * @return Transaction
     */
    public function deposit(int $amount, ?array $meta = null, bool $confirmed = true, bool $public = true): Transaction
    {
        $self = $this;
        return DB::transaction(static function() use ($self, $amount, $meta, $confirmed,$public) {
            return app(CommonService::class)
                ->deposit($self, $amount, $meta, $confirmed,$public);
        });
    }
     ...
     * @return Transaction
     */
    public function forceWithdraw(int $amount, ?array $meta = null, bool $confirmed = true, bool $public = true): Transaction
    {
        $self = $this;
        return DB::transaction(static function() use ($self, $amount, $meta, $confirmed, $public) {
            return app(CommonService::class)
                ->forceWithdraw($self, $amount, $meta, $confirmed, $public);
        });
    }
