<template>
    <div class="service_condition">
        <div class="inside_area">
            <div class="title">
                <span>{{ __('Room service condition')}}</span>
            </div><!-- title -->
            <div class="content_area">
                <pie-chart :chart-data="datacollection" :options="this.pieOptions"></pie-chart>
                <div class="labels_items">
                    <ul>
                        <li class="empty"><i></i>{{ __('Clean')}}</li>
                        <li class="cleanliness"><i></i>{{ __('Under cleaning')}}</li>
                        <li class="maintenance"><i></i>{{ __('Maintenance')}}</li>
                    </ul>
                </div><!-- labels_items -->
            </div><!-- content_area -->
        </div><!-- inside_area -->
    </div><!-- service_condition -->
</template>

<script>
    import PieChart from "../PieChart";
    export default {
        name: "unit-cleaning-status",
        components : {
            PieChart
        },
        data(){
        ...
        methods:{
          getCleaningData(){
              axios.get(`/nova-vendor/DashboardUnits/get-cleaning-data`)
                .then((res) => {
