<template>
  <div id="special_prices_offers">
    <bread-crumb />
    <offers-component :categories="categories" :locale="locale" ref="offers" />
    <special-prices-component :categories="categories" :locale="locale" ref="specialPrices" />
  </div><!-- special_prices_offers -->
</template>

<script>
    import moment from "moment";
    import BreadCrumb from './BreadCrumb';
    import OffersComponent from './child/OffersComponent';
    import SpecialPricesComponent from './child/SpecialPricesComponent';
    export default {
        name: "OffersAndSpecialPrices",
        components : {
            BreadCrumb,
          OffersComponent,
        ...
        methods : {
            getCategories(){
                axios.get('/nova-vendor/units/offers-and-special-prices-categories')
                    .then(response => {
