<template>
  <div id="levels_control">
    <bread-crumb />
		<p class="mb-3 text-90 font-normal text-2xl">{{__('Discount Coupons')}}</p>
    <div class="button_area">
      <button type="button">{{__('Add new coupon')}}</button>
    </div><!-- button_area -->
