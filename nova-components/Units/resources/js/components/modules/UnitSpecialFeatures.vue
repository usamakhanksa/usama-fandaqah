<template>
  <div id="unit_special_features_page">
    <div class="title">
      <span>{{__('Special Features')}}<p>( {{paginator ? paginator.totalResults : 0}} )</p></span>
<!--      <a onclick="Nova.app.$router.push('/resources/unit-special-features/new?viaResource=&viaResourceId=&viaRelationship=')">{{__('Add Special feature')}}</a>-->
    </div><!-- title -->
          ...
          <tbody>
            <template v-if="collection.length">
              <tr v-for="(feature , i) in collection" :key="i">
                ...
                <td>
                  <div class="action">
                    <router-link :to="`/resources/unit-special-features/${feature.id}`" :title="__('View')">
                    ...
                    <router-link :to="`/resources/unit-special-features/${feature.id}/edit?viaResource=&viaResourceId=&viaRelationship=`" :title="__('Edit')">
                    ...
                    <button type="button" :title="__('Delete')" @click="initDeleteConfirm(feature.id)">
            ...
            <template v-else>
              <tr>
                <td colspan="7">{{__('No Special Features Matches Your Criteria')}}</td>
              </tr>
            </template>
          </tbody>
        </table>
  ...
  </div><!-- unit_special_features_page -->
</template>
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            Nova.$on('UnitSpecialFeature-destroyed' , () => {
                this.getData(1);
            });
        },
        created(){
