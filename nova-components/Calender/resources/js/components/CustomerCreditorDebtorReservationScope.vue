<template>
    ...
    <div>
        ...
        <sweet-modal :enable-mobile-fullscreen="false" :pulse-on-block="false" :title="__('Customer Reservations History :customer' , {customer : customer_name })" overlay-theme="dark" class="customer_notes_modal" ref="resScope" @open="fetchData">
...
<script>
    ...
    export default {
        name: "customer-creditor-debtor-reservation-scope",
        components : {
            Loading
        },
        props : ['reservation'],
