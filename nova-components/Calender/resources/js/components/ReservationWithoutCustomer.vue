<template>
  <div id="reservation_page">
    ...
    <div class="main_reservation_buttons" v-if="reservation">
      ...
      <reservation-contract :reservation="reservation" v-if="(reservation.status == 'confirmed' || reservation.status == 'canceled') &&  reservation.reservation_type == 'single'"></reservation-contract>
      ...
      <reservation-cancel
        v-show="( !reservation.checked_in &&  cancel_reservation_before_checkin ) ||
        (reservation.checked_in && reservation.checking_in &&  cancel_reservation_after_checkin_before_revenue )  ||
        (reservation.checked_in && !reservation.checking_in &&  cancel_reservation_after_checkin_after_revenue )"
      ...
      <cancel-checkout v-if="canCancelCheckout && reservation.checked_out" :quick="false"  :reservation_id="reservation.id" v-on:update-reservation="updateReservation"></cancel-checkout>
    ...
    <div v-show="!loading">
      ...
      <div class="checkin_checkout" v-if="reservation">
        ...
        <div @click="gotoPromissoryManagement" v-if="reservation.reservation_type == 'single' && reservation.promissory && reservation.promissory.status == 'pending'" class="cursor-pointer reservation_checked promissory" role="alert">
          <span>
          ...
          <p>{{ __('Reservation has a promissory with number :number with due date' , {number : reservation.promissory.serial})  }} <i class="alert_datte">{{ reservation.promissory.due_date }}</i></p>
        </div>

        <div @click="gotoPromissoryManagement" v-if="reservation.reservation_type == 'group' && reservation.shared_promissory && reservation.shared_promissory.status == 'pending'" class="cursor-pointer reservation_checked promissory" role="alert">
          <span>
            <svg version="1.1" id="Layer_1" width="50" height="40" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 512 512" xml:space="preserve"><path class="st0" d="M448.8 225.7c4.2 0 7.6-3.4 7.6-7.6V99.2c0-9.6-7.8-17.4-17.4-17.4h-29.7V58.3c0-9.6-7.8-17.4-17.4-17.4h-30.7V17.4c0-9.6-7.8-17.4-17.4-17.4H134.5c-4.2 0-7.6 3.4-7.6 7.6 0 4.2 3.4 7.6 7.6 7.6h209.1c1.2 0 2.3 1 2.3 2.3v395.3c0 1.2-1 2.3-2.3 2.3H73.4c-1.3 0-2.3-1-2.3-2.3V17.4c0-1.3 1-2.3 2.3-2.3h30.8c4.2 0 7.6-3.4 7.6-7.6 0-4.2-3.4-7.6-7.6-7.6H73.4C63.8 0 56 7.8 56 17.4v395.3c0 9.6 7.8 17.4 17.4 17.4h30.7v23.5c0 9.6 7.8 17.4 17.4 17.4h29.7v23.5c0 9.6 7.8 17.4 17.4 17.4h270.2c9.6 0 17.4-7.8 17.4-17.4V248.4c0-4.2-3.4-7.6-7.6-7.6-4.2 0-7.6 3.4-7.6 7.6v246.2c0 1.3-1 2.3-2.3 2.3h-270c-1.2 0-2.3-1-2.3-2.3v-23.5h225.4c9.6 0 17.4-7.8 17.4-17.4V348.9c0-4.2-3.4-7.6-7.6-7.6-4.2 0-7.6 3.4-7.6 7.6v104.8c0 1.3-1 2.3-2.3 2.3H121.5c-1.3 0-2.3-1-2.3-2.3v-23.5h224.4c9.6 0 17.4-7.8 17.4-17.4V56.1h30.7c1.3 0 2.3 1 2.3 2.3v260.2c0 4.2 3.4 7.6 7.6 7.6 4.2 0 7.6-3.4 7.6-7.6V97h29.7c1.3 0 2.3 1 2.3 2.3v118.8c0 4.2 3.4 7.6 7.6 7.6z"/><path class="st0" d="M251.3 75c0-23.6-19.2-42.7-42.7-42.7S165.8 51.4 165.8 75s19.2 42.7 42.7 42.7 42.8-19.1 42.8-42.7zm-70.4 0c0-15.2 12.4-27.6 27.6-27.6s27.6 12.4 27.6 27.6-12.4 27.6-27.6 27.6-27.6-12.4-27.6-27.6zM311.9 82.6c4.2 0 7.6-3.4 7.6-7.6 0-4.2-3.4-7.6-7.6-7.6h-35.5c-4.2 0-7.6 3.4-7.6 7.6 0 4.2 3.4 7.6 7.6 7.6h35.5zM140.7 67.4h-35.5c-4.2 0-7.6 3.4-7.6 7.6 0 4.2 3.4 7.6 7.6 7.6h35.5c4.2 0 7.6-3.4 7.6-7.6 0-4.2-3.4-7.6-7.6-7.6zM115.1 146.9c0 4.2 3.4 7.6 7.6 7.6h171.7c4.2 0 7.6-3.4 7.6-7.6 0-4.2-3.4-7.6-7.6-7.6H122.7c-4.2 0-7.6 3.4-7.6 7.6zM294.4 176.1H122.7c-4.2 0-7.6 3.4-7.6 7.6s3.4 7.6 7.6 7.6h171.7c4.2 0 7.6-3.4 7.6-7.6s-3.4-7.6-7.6-7.6zM294.4 212.8H122.7c-4.2 0-7.6 3.4-7.6 7.6 0 4.2 3.4 7.6 7.6 7.6h171.7c4.2 0 7.6-3.4 7.6-7.6 0-4.2-3.4-7.6-7.6-7.6zM294.4 249.5H122.7c-4.2 0-7.6 3.4-7.6 7.6 0 4.2 3.4 7.6 7.6 7.6h171.7c4.2 0 7.6-3.4 7.6-7.6 0-4.2-3.4-7.6-7.6-7.6zM294.4 286.3H122.7c-4.2 0-7.6 3.4-7.6 7.6 0 4.2 3.4 7.6 7.6 7.6h171.7c4.2 0 7.6-3.4 7.6-7.6 0-4.2-3.4-7.6-7.6-7.6zM297.7 324.7c-3.2-2.7-8-2.2-10.7 1.1l-36.2 44.1-16.8-16.4c-3-2.9-7.8-2.9-10.7.1-2.9 3-2.9 7.8.1 10.7l18.8 18.4c5.3 5.2 13.8 4.7 18.5-1l38-46.3c2.7-3.2 2.2-8-1-10.7z"/></svg>
          </span>
        ...
        <div class="right_col">
          ...
          <div class="booking_summary" v-if="reservation">
            <div class="title">
              ...
              <reservation-edit v-if="!reservation.checked_out && (reservation.status == 'confirmed' || reservation.status == 'canceled' || reservation.status == 'awaiting-payment')" :occ="occ"  :reservation="reservation" @update-reservation="updateReservation"></reservation-edit>
              <reservation-edit v-if="occ && reservation.checked_out"  :occ="occ" :reservation="reservation" @update-reservation="updateReservation"></reservation-edit>
            </div><!-- title -->
            <div class="content">
              <ul>
                <li class="oneline">
                  ...
                  <div class="col_two">
                    <div class="desc" >
                      <span style="direction: ltr;"> #{{reservation.number}} </span>
                ...
                <li class="oneline">
                  ...
                  <div class="Leasing">
                    <span>{{  (reservation.total_price).toFixed(2) }} <span v-if="(currency && currency == 'SAR') || !currency" class="icon-saudi_riyal"></span> <span v-else>{{ __(currency) }}</span></span>
          ...
          <group-reservations-manual-invoices :reservation="reservation" :occ="occ" />
                ...
                <div class="financial_item"  v-for="(transaction,index) in reservation.transactions.slice(0,4)" :key="index" @click="openTransactionModal(transaction)">
                  ...
                  <div class="col_left">
                    ...
                    <div class="name">
                      ...
                      <label v-bind:class="{ 'text-danger': transaction.type == 'withdraw' ,'text-success': transaction.type == 'deposit' }">
              ...
              <div class="all_financial_items" v-if="reservation.reservation_type == 'group' && reservation.group_reservation_transactions.length">
                <div class="financial_item"  v-for="(transaction,index) in reservation.group_reservation_transactions.slice(0,4)" :key="index" @click="openTransactionModal(transaction)">
                  ...
                  <div class="col_left">
                    ...
                    <div class="name">
                      <p v-if="transaction.is_insurance">{{__('Insurance')}}</p>
                      <label v-bind:class="{ 'text-danger': transaction.type == 'withdraw' ,'text-success': transaction.type == 'deposit' }">{{__(transaction.meta.payment_type)}} | {{__(transaction.type)}}</label></div>
                  </div><!-- col_left -->
                </div><!-- financial_item -->
            ...
            <div class="content">
              <div class="block_top">
                <ul>
                  ...
                  <customer-creditor-debtor v-if="reservation && reservation.reservation_type == 'single'" ref="initCustomerCreditorDebitorModal" :customer_id="reservation.customer_id" :reservation_id="reservation.id" :total_balance="total_balance" :reservations_count="reservations_count"/>
              ...
              <div class="block_bottom">
                <AttachCustomer :reservation="reservation" />
                <remove-company :reservation="reservation" />
                <change-company :reservation="reservation" />
                 <!-- <button @click="openAttachCustomerModalFromParent" class="more">{{__('Attach customer to reservation')}}</button> -->
                <button @click="reservation.reservation_type == 'single' ? pushToCustomerDetails(reservation.customer.id) : pushToCompanyDetails(reservation.company_id)" class="more">{{__('more')}} ..</button>
              </div>
            </div><!-- content -->
      ...
      <!-- Start Add Deposit  -->
      <sweet-modal :enable-mobile-fullscreen="false" :pulse-on-block="false" title="Add Deposit" overlay-theme="dark" ref="depositModal">
        <div class="flex mt-1">
          <div class="mb-4 w-full ">
            <label class="block text-gray-700 text-sm font-bold">{{__('Payment Type')}}</label>
            <div class="relative">
              <select v-model="deposit_type" class="block w-full bg-gray-200 border border text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
        ...
        <div class="flex mt-1">
          <div class="mb-4 w-full">
            <label class="block text-gray-700 text-sm font-bold ">{{__('Amount')}}</label>
            <input type="number" v-model="deposit_amount" class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight" placeHolder="Price">
          </div>
        </div>
        <button class="shadow mb-4  btn btn-default btn-block btn-primary mt-2" @click="sendDeposit">{{__('Add Deposit')}}</button>
      </sweet-modal>
      <!-- End Add Deposit  -->
      ...
      <sweet-modal v-if="current_transaction" :enable-mobile-fullscreen="false" :pulse-on-block="false" width="70%" :title="__('Transaction Details')" overlay-theme="dark" ref="transactionModal" class="transaction_modal">
        <div class="share_button_reservation">
          ...
          <a class="print_button" :href="'/home/reservation/sub-invoice/'+transaction_hash_id" target="_blank"></a>

          <!-- <button>{{ (current_transaction.type === 'deposit' && !reservation.checked_out && reservation.status != 'canceled') || ( (reservation.status == 'confirmed' || reservation.status == 'awaiting-payment' || reservation.status == 'awaiting-confirmation') && occ) }}</button> -->
          <template v-if="(current_transaction.type === 'deposit' && !reservation.checked_out && reservation.status != 'canceled') || ( (reservation.status == 'canceled') && occ)">
              <button class="edit_button" v-permission="'edit receipts'" @click="openEditTransation"></button>
          </template>
          <template v-else-if="(current_transaction.type === 'withdraw' && !reservation.checked_out && reservation.status != 'canceled') || ( (reservation.status == 'confirmed' || reservation.status == 'awaiting-payment' || reservation.status == 'awaiting-confirmation') && occ)">
              <button class="edit_button" v-permission="'edit payments'" @click="openEditTransation"></button>
          </template>
          <!-- <button>{{ ( (reservation.status == 'confirmed' || reservation.status == 'awaiting-payment' || reservation.status == 'awaiting-confirmation') && occ) }}</button> -->
          <button class="trash_button" @click="deleteTransaction(current_transaction.id)" v-if="((current_transaction.meta && current_transaction.meta.statement != 'Billed Online') && (current_transaction.meta && current_transaction.meta.statement != 'Billed Online Fulfill Promissory Number')) && (!reservation.checked_out && reservation.status != 'canceled') || (occ)"  v-permission="'delete statements'" v-show="!hideDeleteButton"></button>
...
<!--          <embed :src="'/home/reservation/pdf/sub-invoice/' + transaction_hash_id " type="application/pdf">-->
      ...
      <sweet-modal v-if="reservation" :enable-mobile-fullscreen="false" :pulse-on-block="false"  width="70%" :title="__('Invoice')" overlay-theme="dark" ref="invoiceModal" class="invoice_modal">
        <div class="share_button_reservation">
          ...
          <a class="print_button" :href="'/home/reservation/generalInvoice/' + reservation.hash_id + '?lang=' + local  " target="_blank"></a>
        </div><!-- share_button_reservation -->
        <div class="embed_area">
<!--          <embed :src="'/home/reservation/pdf/generalInvoice/' + reservation.hash_id" type="application/pdf">-->
      ...
      <!-- End Invoice -->
       <edit-note :comment="targetComment"  ref="editNoteHandler" />
        <delete-note-confirm v-if="targetComment" :id="targetComment.id" ref="deleteNoteHaandlerFromReservation" />


          <!-- <attach-customer ref="attachCustomerHandler" :reservation="reservation" /> -->
...
<script>
  ...
  import AttachCustomer from './partial/AttachCustomer';
...
export default {
    name: "reservation-without-customer",
    components: {
        AddInvoice,
        Loading,
        CancelCheckout,
      ...
      methods: {
        ...
        formatDateCustom(date){
            ...
            openAttachCustomerModalFromParent(){

                this.$refs.attachCustomerHandler.$refs.attachCustomer.open();
            ...
            pushToCompanyDetails(id){
                Nova.app.$router.push(`/companies/${id}/profile`) ;
            },
            openCustomerModal() {
            ...
            getReservation() {
                ...
                axios
                    .get('/nova-vendor/calender/reservation-noc/' + this.$route.params.id, config)
                    .then( (response) => {
                        ...
                        if(this.reservation.group_reservation){
                            Nova.$emit('moving-btw-reservations-done');
                        }
            ...
            sendDeposit() {
                ...
                if (!this.deposit_amount || !this.deposit_type) {
                    this.$toasted.show(this.__('Please fill all deposit info'), {type: 'error'});
      ...
      mounted() {
        if(this.$route.query.occ){
          ...
          this.cancel_reservation_before_checkin = Nova.app.$hasPermission('cancel reservation before checkin');
            ...
            Nova.$on('attached-customer-successfully' , () => {
              Nova.app.$router.push(`/reservation/${this.reservation.id}`) ;
            })
