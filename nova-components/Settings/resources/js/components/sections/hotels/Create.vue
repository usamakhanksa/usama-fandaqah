...
<!--        <heading class="mb-3">{{ __('Add New Hotel') }}</heading>-->
        <p class="mb-3 text-90 font-normal text-2xl">{{__("Add New Hotel")}}</p>
        <card class="overflow-hidden">
            <form v-if="fields" @submit.prevent="createResource" autocomplete="off">
                ...
                <!-- Create Button -->
                <div class="bg-30 flex justify-between items-center p-4">
                    ...
                    <a
                            @click="$router.back()"
                            class="btn btn-default bg-gray-600 hover:bg-gray-700 text-white inline-flex items-center relative cursor-pointer"
                    >
                        {{ __('Cancel') }}
                    </a>
