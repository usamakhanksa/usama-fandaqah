<template>
    <div>
        <button class="table" @click="openCreateCustomerModal">{{__('Add New Customer')}}</button>
        <sweet-modal :enable-mobile-fullscreen="false" :pulse-on-block="false" :title="__('Add New Customer')" overlay-theme="dark" ref="createCustomerModal" class="cancel_reservation_modal customer_modal_crud">

            <div class="customer_create relative">
                ...
                <div class="row_group">
                    ...
                    <div class="col">
                        <label>{{ customer.id_type == 5 ? __('Passport Number') : __('ID Number')}}</label>
                ...
                <div class="row_group">
                    <div class="col">
                        <label>{{__('Gender')}}<i v-if="SCTH">*</i></label>
                ...
                <div class="row_group">
                    ...
                    <div class="col">
                        ...
                        <select v-model="customer.highlight_id">
                            <option :value="null" selected="selected">{{__('Choose a highlight')}}</option>     
        ...
        <div class="action_buttons">
            <button class="table w-full" @click="store()">{{__('Create Customer')}}</button>
        </div><!-- action_buttons -->
    </sweet-modal>
    </div>
...
"code" : 5,
    ...
    methods: {
        ...
        store() {
            ...
            this.isLoading = true;
            axios
            .post('/nova-vendor/new/customers', this.customer)
            .then(response => {
