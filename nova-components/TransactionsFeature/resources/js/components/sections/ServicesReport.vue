        ...
        <div class="filter_area">
          ...
          <div class="item">
            <input
              ...
              @input="getServicesTransactions"
            >
          </div><!-- item -->

            <div class="item">
                <select @change="getServicesTransactions" v-model="unitId">
                    <option value="null" selected="selected">{{__('The Unit')}}</option>
                    <template v-if="units.length">
                        <template v-for="unit in units">
                            <option :value="unit.id">{{unit.unit_number}} - {{unit.name[locale]}}</option>
                        </template>
                    </template>
                </select>
            </div><!-- item -->
            ...
            <div class="item">
                <select @change="getServicesTransactions" v-model="transactionType">
                    <option value="null" selected="selected">{{__('Type')}}</option>
          ...
          <div class="item">
            <select @change="getServicesTransactions" v-model="employeeId">
            ...
            <div class="item">
                <select @change="getServicesTransactions" v-model="serviceType">
                    <option value="null" selected="selected">{{__('Service Type')}}</option>
                    <template v-if="servicesTypes.length">
                        <template v-for="type in servicesTypes">
...
<!--                        <button  :title="__('Edit')" @click="openEditTransactionModal(obj)" v-permission="'edit service transaction'">-->
<!--                            <icon type="edit" width="22" height="30" view-box="0 0 22 16" />-->
<!--                        </button>-->

                        <button  :title="__('Delete')" @click="deleteHandler(obj.id)" v-permission="'delete service transaction'">
    ...
    export default {
        ...
        methods : {
            ...
            getServicesCategories(){
                ...
                axios.get('/nova-vendor/transactions-feature/services-categories-names')
                    .then(response => {
            ...
            getServicesTransactions(dPagi=1){
                ...
                dPagi = '/nova-vendor/transactions-feature/services-report?page='+ dPagi + '&team_id=' + this.team_id + '&dateFrom='+ this.dateFrom + '&dateTo=' + this.dateTo
            ...
            fetchUnits(){
                axios.get('/nova-vendor/transactions-feature/fetchUnits')
                    .then((res) => {
                        this.units = res.data;
                    })
                    .catch((err) => {
            ...
            openEditTransactionModal(transaction){
                ...
                this.transaction.payable_type === 'App\\Team' ? Nova.$emit('open-deposit-modal' , this.transaction) : Nova.$emit('open-withdraw-modal' , this.transaction);
            },
        ...
        mounted() {
            ...
            this.team_id = Nova.app.currentTeam.id;
