<template>
    <div>
        ...
        <div id="deposit_management_page">
            <div class="title">{{ __('History and Forecast') }}</div>
            <div class="content_page">
                ...
                <div class="action_buttons">
                    <div class="buttons_area" v-if="data && data.dates">
                    ...
                    <div class="table-responsive relative">
                        ...
                        >
                            ...
                            <tr>
                                ...
                                <th>{{__('House Use Rooms')     }}</th>
                                <th>{{__('Deducted Individuals')}}</th>
                                <th>{{__('Deducted Group')      }}</th>
                                <th>{{__('Occupied Percentage') }}</th>
                                <th>{{__('Revenue')             }}</th>
                                <th>{{__('Average Rate')        }}</th>
                                <th>{{__('Departure Rooms')     }}</th>
                                <th>{{__('Day Use Rooms')       }}</th>
                                <th>{{__('No Show Rooms')       }}</th>
                                <th>{{__('OOO Rooms')           }}</th>
                                <th>{{__('Adlts and Chlds')     }}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <template v-if="data">
                                <tr v-for="(obj,index) in data.dates" :key="index">
                                    <td>{{ obj                                  }}</td>
                                    <td>{{ data.occupied_units[obj]             }}</td>
                                    <td>{{ data.arrival_units[obj]              }}</td>
                                    <td>{{ data.complimentary_rooms[obj]        }}</td>
                                    <td>{{ data.house_use_rooms[obj]            }}</td>
                                    <td>{{ data.deducted_individuals[obj]       }}</td>
                                    <td>{{ data.deducted_group[obj]             }}</td>
                                    <td>{{ data.occupied_percentage[obj]        }}</td>
                                    <td>{{ data.revenue[obj]                    }}</td>
                                    <td>{{ data.average_revenue_per_unit[obj]   }}</td>
                                    <td>{{ data.departure_rooms[obj]            }}</td>
                                    <td>{{ data.day_use_rooms[obj]              }}</td>
                                    <td>{{ data.no_show_rooms[obj]              }}</td>
                                    <td>{{ data.ooo_rooms[obj]                  }}</td>
                                    <td>{{ data.res_guests[obj]                 }}</td>
                                </tr>
                            </template>
                            <template v-else>
                                <tr>
                ...
                <div v-else class="table_area">
                    <div class="no_data_show">
                            ...
                            <span>{{__('Please start to select month and year to initiate history and forecast report')}}</span>
                    </div><!-- no_data_show -->
                </div>
            </div>
        </div>
        ...
        <!-- Single Print  -->
        <form id="invoices_form" target="_blank" method="post"  style="display: none" action="/home/print/historyForecastReportPrint">
...
export default {
    ...
    methods:{
        ...
        excelExport(){
            ...
            axios.post(window.FANDAQAH_API_URL + '/reports/history-forecast-excel' , {
                'data' : this.data ,
        ...
        getData(){
            ...
            axios.get(window.FANDAQAH_API_URL + `/reports/history-forecast` , config)
                .then((response) => {
