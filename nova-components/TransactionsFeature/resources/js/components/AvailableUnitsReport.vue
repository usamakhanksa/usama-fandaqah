<template>
    <div>
        ...
        <div id="deposit_management_page">
            <div class="title">{{ __('Available Units Report') }}</div>
            <div class="content_page">
                ...
                <div class="action_buttons">
                    ...
                    <p style="font-size: 1.125rem;"><b>{{__('Total Available Units')}}  : {{totalAvailableUnits}}</b></p>
                ...
                <div class="table_area">
                    <div class="table-responsive relative">
                        ...
                        >
                            ...
                            <template v-else>
                                <tr>
                                    <td colspan="2">{{__('No Units Found!')}}</td>
                                </tr>
                            </template>
                            </tbody>
                        </table>
...
export default {
    ...
    methods:{
        ...
        getData(){
            ...
            axios.get(window.FANDAQAH_API_URL + `/units/available-report` , config)
                .then((response) => {

                    if(response.data.message == 'data found'){
                        this.data = response.data.data;
                        this.totalAvailableUnits = response.data.totalAvailableUnits;
                    }else{
                        this.data = [];
    ...
    watch:{
        ...
        dateValues: {
                ...
                if((val.dateFrom != null ) && (val.dateTo != null )){
                    let opt = {}
                    opt["filter[by_date_from]"] = val.dateFrom;
                    opt["filter[by_date_to]"] = val.dateTo;
                    opt["page"] = 1;
                    this.$router.push({
                        name : 'units-available-report',
