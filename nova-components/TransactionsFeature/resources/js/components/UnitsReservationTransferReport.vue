<template>
    <div>
        ...
        <div id="units_reservation_transfer">
            <div class="title">{{ __('Reservation Transfers') }}</div>
                    ...
                    <div class="table-responsive relative">
                        ...
                        >
                            ...
                            <tr>
                                ...
                                <th>{{__('Old Unit Number')}}</th>
                                <th>{{__('Old Date In')}}</th>
                                <th>{{__('Old Date Out')}}</th>
                                <th>{{__('Old Price')}}</th>
                                <th>{{__('New Unit Number')}}</th>
                                <th>{{__('New Date In')}}</th>
                                <th>{{__('New Date Out')}}</th>
                                <th>{{__('New Price')}}</th>
                                <th>{{__('Reason')}}</th>
                                <th>{{__('Creator')}}</th>
                            </tr>
                            ...
                            <template v-if="data.length">
                                <tr v-for="(obj,index) in data" :key="index">
                                    ...
                                    <td v-if="obj.old_unit"><router-link :to="{path : `/resources/units/${obj.old_unit.id}`}" class="text-info-dark">{{ obj.old_unit.number}}</router-link></td>
                                    <td v-else>-</td>
                                    <td>{{obj.old_date_in}}</td>
                                    <td>{{obj.old_date_out}}</td>
                                    <td>{{obj.old_price}}</td>
                                    <td v-if="obj.new_unit"><router-link :to="{path : `/resources/units/${obj.new_unit.id}`}" class="text-info-dark">{{obj.new_unit.number}}</router-link></td>
                                    <td v-else>-</td>
                                    <td>{{obj.new_date_in}}</td>
                                    <td>{{obj.new_date_out}}</td>
                                    <td>{{obj.new_price}}</td>
                                    <td>{{obj.reason}}</td>
...
export default {
    ...
    methods:{
        ...
        getData(){
            ...
            axios.get(window.FANDAQAH_API_URL + `/units/units-reservation-transfer` , config)
                .then((response) => {
