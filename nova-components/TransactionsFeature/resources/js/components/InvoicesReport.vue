                        ...
                        >
                            ...
                            <template v-if="data.length">
                                <tr v-for="(obj,index) in data" :key="index">
                                    <td>{{obj.number}}</td>
                                     <td v-if="obj.reservation">
                                        <router-link v-if="!obj.reservation.deleted_at" :to="{name : 'reservation' , params : {id :  obj.reservation.id }}" class="text-info-dark">{{obj.reservation.number}}</router-link>
                                        <p v-else>{{obj.reservation.number}}</p>
                                    </td>
                                    <td v-else>-</td>

                                    <td v-if="obj.reservation && obj.reservation.customer && !obj.reservation.company">{{obj.reservation && obj.reservation.customer  ? obj.reservation.customer.name : '-'}}</td>
                                    <td v-else>{{obj.reservation.company.name}}</td>
                                    <td>{{obj.employee ? obj.employee.name : '-'}}</td>
                                    <td>{{obj.amount}} </td>
                                    <td>{{obj.vat_sum ? obj.vat_sum : 0}}</td>
                                    <td>{{obj.created_at}}</td>
                                    <td>{{obj.period_from}}</td>
                                    <td>{{obj.period_to}}</td>
                                    <td v-permission = "'print invoices'" class="td-fit">
                                        <a
                                        v-if="obj.reservation.reservation_type == 'single'"
                                            :href="obj.print_url"
                                            target="_blank"
                                            v-tooltip="{
                                                targetClasses: ['it-has-a-tooltip'],
                                        ...
                                        <a
                                        v-else
                                            :href="`/home/reservation/group-invoice?inv=${obj.hash_id}&locale=${locale}`"
                                            target="_blank"
                                            v-tooltip="{
                                                targetClasses: ['it-has-a-tooltip'],
                                                placement: 'top',
                                        ...
                                        <!-- <a  class="show_credit_note_button" @click="openShowCreditNoteModal(obj)"></a> -->
                                        <a
                                        v-permission = "'print invoices'"
                                        v-if="obj.invoice_credit_note && obj.reservation.reservation_type == 'single'"
                                            :href="'/home/reservation/credit-note/' +  obj.invoice_credit_note.hash_id"
                                            target="_blank"
                                            v-tooltip="{
                                                targetClasses: ['it-has-a-tooltip'],
                                                placement: 'top',
                                        ...
                                        <a
                                        v-if="obj.invoice_credit_note && obj.reservation.reservation_type == 'group'"
                                            :href="`/home/group_reservation/company_invoice_credit_note/${obj.invoice_credit_note.hash_id}?locale=${locale}`"
                                            target="_blank"
                                            v-tooltip="{
                                                targetClasses: ['it-has-a-tooltip'],
                                                placement: 'top',
...
export default {
    ...
    methods:{
        ...
        excelExport(){
            ...
            axios.post(window.FANDAQAH_API_URL + '/reservations/invoices-report-excel' , {
                'ids' : this.ids ,
        ...
        getData(){
            ...
            axios.get(window.FANDAQAH_API_URL + `/reservations/invoices-report` , config)
                .then((response) => {
    ...
    mounted() {
        ...
        this.crumbs = [
            ...
            {
                text : 'Reservations Invoices Report',
                to : '#'
            }
        ];
        this.query = this.$route.query;
