<template>
  <div class="p-6 space-y-6 bg-[#f8f9fa] min-h-full">
    <!-- Header Section -->
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 custom-rounded shadow-sm border border-slate-50">
      <div>
    ...
    <div class="bg-white p-6 custom-rounded shadow-sm border border-slate-50 flex flex-col lg:flex-row gap-4 items-center">
    ...
    <!-- View Content -->
    <div v-if="viewType === 'list'" class="bg-white custom-rounded shadow-sm border border-slate-50 overflow-hidden">
    ...
    <div v-else-if="viewType === 'grid'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="row in rows" :key="row.id" class="bg-white custom-rounded p-6 shadow-sm border border-slate-50 hover:border-[#e95a54] transition-all group">
