...
CREATE TABLE IF NOT EXISTS `invoice_transfers` (
  ...
  `promissory_id` int(10) unsigned NOT NULL COMMENT 'FK to promissories.id — the AR record created',
...
CREATE TABLE IF NOT EXISTS `transactions` (
  ...
  `team_id` bigint(20) DEFAULT NULL,
  `correction_of_transaction_id` int(10) unsigned DEFAULT NULL COMMENT 'FK to transactions.id — links reversal to original.',
